...
pub use decoder::NormalizedCancelRequestDecoder;
pub use encoder::NormalizedCancelRequestEncoder;
...
pub mod encoder {
    ...
    pub struct NormalizedCancelRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for NormalizedCancelRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for NormalizedCancelRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> NormalizedCancelRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct NormalizedCancelRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for NormalizedCancelRequestDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for NormalizedCancelRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for NormalizedCancelRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> NormalizedCancelRequestDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
