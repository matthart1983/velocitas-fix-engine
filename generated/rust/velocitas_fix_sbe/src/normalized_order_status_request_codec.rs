...
pub use decoder::NormalizedOrderStatusRequestDecoder;
pub use encoder::NormalizedOrderStatusRequestEncoder;
...
pub mod encoder {
    ...
    pub struct NormalizedOrderStatusRequestEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for NormalizedOrderStatusRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for NormalizedOrderStatusRequestEncoder<'a> {
        #[inline]
    ...
    impl<'a> NormalizedOrderStatusRequestEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct NormalizedOrderStatusRequestDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for NormalizedOrderStatusRequestDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for NormalizedOrderStatusRequestDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for NormalizedOrderStatusRequestDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> NormalizedOrderStatusRequestDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
