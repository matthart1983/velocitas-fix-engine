...
pub use decoder::FixAeronEnvelopeDecoder;
pub use encoder::FixAeronEnvelopeEncoder;
...
pub mod encoder {
    ...
    pub struct FixAeronEnvelopeEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for FixAeronEnvelopeEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for FixAeronEnvelopeEncoder<'a> {
        #[inline]
    ...
    impl<'a> FixAeronEnvelopeEncoder<'a> {
        ...
        /// - version: 0
        #[inline]
        pub fn published_at(&mut self, value: u64) {
            let offset = self.offset;
            self.get_buf_mut().put_u64_at(offset, value);
        }

        /// primitive field 'BaseStreamId'
        ...
        /// - version: 0
        #[inline]
        pub fn base_stream_id(&mut self, value: i32) {
...
pub mod decoder {
    ...
    pub struct FixAeronEnvelopeDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for FixAeronEnvelopeDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for FixAeronEnvelopeDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for FixAeronEnvelopeDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> FixAeronEnvelopeDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn base_stream_id(&self) -> i32 {
