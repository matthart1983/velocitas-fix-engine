...
pub use decoder::NormalizedOrderDecoder;
pub use encoder::NormalizedOrderEncoder;
...
pub mod encoder {
    ...
    pub struct NormalizedOrderEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for NormalizedOrderEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for NormalizedOrderEncoder<'a> {
        #[inline]
    ...
    impl<'a> NormalizedOrderEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct NormalizedOrderDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for NormalizedOrderDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for NormalizedOrderDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for NormalizedOrderDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> NormalizedOrderDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        #[inline]
        pub fn price_slice(&'a self, coordinates: (usize, usize)) -> &'a [u8] {
            debug_assert!(self.get_limit() >= coordinates.0 + coordinates.1);
            self.get_buf().get_slice_at(coordinates.0, coordinates.1)
        }
